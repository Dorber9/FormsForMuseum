            ...
            > {
                ...
                div style = {
                    ...
                    props.object.ImagePath ? ( <
                        img src = { props.object.ImagePath }
                        style = {
                            { height: "250px" } }
                    ...
                    questionsFlag == false ? ( <
                        ...
                        onSubmit = { handleSubmit } > {
                            inputFields.map((inputField) => ( <
                                ...
                                label = "Description"
                                variant = "outlined"
                                multiline fullWidth value = { inputField.categoryDescr }
                                onChange = {
                                    (event) =>
                                    handleChangeInput(inputField.id, event)
                                }
                        ...
                        SUBMIT <
                        /Button> { /* <button onClick={getItems}>Show Items</button> */ } <
                        /form> <
                        /div> {
                            props.object == null ? (
                                    ""
                                    ...
                                    Popup modal trigger = { < Button
                                        ...
                                        /Button>} position="center"> {
                                            close => ( <
                                                ...
                                                onClick = { deleteItem }
                                                variant = "contained" > Yes < /Button> <Button  style={{
                                                color : "white",
                                                background: "red",
                                                marginLeft: "10px",
                                            }
                            ...
                            div style = {
                                { color: "black" } } > Modified Successfully! < /div>
                        )
                    } <
                    /Card.Text> <
                    /Card.Body> <
