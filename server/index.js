...
app.post("/addShowcase", (req, res) => {
    ...
    db.query(
        "INSERT INTO showcase (Number,Name,Descr,Type,SpecialCare,SpecialCareDescr,DisplayID,ImagePath) VALUES (?,?,?,?,?,?,?,?)", [Number, Name, Descr, Type, SpecialCare, SpecialCareDescr, DisplayID, ImagePath],
        (err, result) => {
            if (err) {
                console.log(err);
            } else {
