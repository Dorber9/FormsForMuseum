...
const ModifyData = () => {
    ...
    return (
        ...
        div className = "tb"
        style = {
            { minHeight: `calc(100vh - 80px)`, textAlign: "center" } } >
        <
        h5 style = {
            { color: "white", marginTop: "10px" } } > Hello, what would you like to modify ? < /h5> <
        div style = {
            {
                display: "flex",
                ...
                } >
                {
                    selectedObject == "" || selectedObject == "Question" ? (
                        ...
                        value = {
                            {
                                value: wantedObject,
                                label: objectName === "" ? "Select " + selectedObject : objectName,
                            }
                        }
                        maxMenuHeight = { 180 }
                        options = { mapOptions() }
