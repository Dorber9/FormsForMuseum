...
const AddQuestion = (props) => {
        ...
        return ( <
            ...
            <
            Card.Title style = {
                { color: "black" } } > { props.object == null ? "Add Questions" : "Modify Questions" } <
            /Card.Title> <
            Card.Body >
            <
            Card.Text >
            ...
            } >
            {
                props.itemId != null ? ( <
                    ...
                    value = {
                        { value: props.itemId, label: props.itemName } }
                    styles = { selectStyles }
                    options = {
                ...
                wantedItem === "" && props.object == null ? (
                        ...
                        form className = { classes.root } > {
                            inputFields.map((inputField) => ( <
                                ...
                                style = {
                                    { zIndex: 1, width: "80%" } }
                                hiddenLabel value = { inputField.question }
                                onChange = {
                                    (event) =>
                                ...
                                <
                                Select defaultInputValue = { inputField.correct }
                                options = { options }
                                styles = { selectStyles }
                                onChange = {
                                    (e) => {
