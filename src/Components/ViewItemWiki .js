    ...
    return ( <
        > {
            loading ? ( <
                ...
                <
                h1 style = {
                    { textAlign: "center" } } > { itemData.ItemName } < /h1>
                ...
                nbsp; מוצג זה נמצא ב { itemData.Site }.גילו הוא בערך & nbsp; { itemData.Age }, ולפיכך הוא משתייך לתקופה ה & nbsp; { itemData.Period } { " " }
                .חומרו של המוצג הוא & nbsp; { itemData.Material }. <
                /h2> <
                /div>
