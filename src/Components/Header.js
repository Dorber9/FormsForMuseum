      ...
      <Navbar style={{background:"black",boxShadow: "rgb(210 188 125) 0px 0px 5px",height:"50px"}} bg="dark" variant="dark">
        <Container style={{marginLeft:"33%"}}>
          ...
          <Nav className="me-auto">
            ...
            { (window.location.pathname=="/Add" ||window.location.pathname=="/ModifyData") ?
             <span style={{borderBottom: "1px solid white" , color: "#e9c363", marginTop:"8px",marginLeft:"96px", position:"absolute"}}>Data</span>: 
             <span style={{ color: "white", marginTop:"8px",marginLeft:"96px", position:"absolute"}}>Data</span>}
            <NavDropdown title={ (window.location.pathname=="/Add" ||window.location.pathname=="/ModifyData") ? "Data": "Data"}>
