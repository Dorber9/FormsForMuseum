...
app.post("/upload", (req, res) => {
    upload(req, res, function(err) {
        ...
        res.json(`${__dirname}/../../frontEnd/public/uploads/${req.file.filename}`)
        console.log(`${__dirname}/../../frontEnd/public/uploads/${req.file.filename}`)
            /*Now do where ever you want to do*/
        if (!err) {
            return `${__dirname}/../../frontEnd/public/uploads/${req.file.filename}`;
        } else {
